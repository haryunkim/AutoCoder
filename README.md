# AutoCoder
This is a practice project that builds a reusable GitHub Action that leverages AI to auto-generate code. It will involve creating workflows, interact with OpenAI API using scripts, and enforce security standards. 
